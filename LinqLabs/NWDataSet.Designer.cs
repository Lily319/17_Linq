...
SELECT OrderID, ProductID, UnitPrice, Quantity, Discount FROM [Order Details] WHERE (OrderID = @OrderID) AND (ProductID = @ProductID)";
        ...
        public virtual int FillByID(NWDataSet.Order_DetailsDataTable dataTable, int orderID) {
        ...
        public virtual NWDataSet.Order_DetailsDataTable GetDataByID(int orderID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(orderID));
            NWDataSet.Order_DetailsDataTable dataTable = new NWDataSet.Order_DetailsDataTable();
            this.Adapter.Fill(dataTable);
